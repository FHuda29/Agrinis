...
import com.agrinis.app.databinding.NewsHeadlineItemsBinding
...
import com.agrinis.app.ui.category.fragment.MainFragment_GeneratedInjector
import com.agrinis.app.util.callbacks.NewsTitleClickListener
import com.agrinis.app.util.helper.CustomTabHelper

class HeadlinesAdapter(private val articles: List<Article>,private val context:Context): RecyclerView.Adapter<HeadlinesAdapter.ArticleHolder>() {
    private var customTabHelper: CustomTabHelper = CustomTabHelper()
    class ArticleHolder(val view: NewsHeadlineItemsBinding): RecyclerView.ViewHolder(view.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ArticleHolder {
        val binder = DataBindingUtil.inflate<NewsHeadlineItemsBinding>(
            LayoutInflater.from(parent.context),
            R.layout.news_headline_items,
            parent,
            false
        )
